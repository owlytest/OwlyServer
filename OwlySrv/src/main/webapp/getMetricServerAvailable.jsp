...
logger.debug("parameters received : nameserver="+nameRemServer+" and ipserver="+ipRemServer +" and type_stat="+type_stat+" and type_metric="+type_metric+" and minutes_to_check="+minutes);
...
boolean metrics_available = remoteBasicStatMongoDAO.isThereMetricDetails(shortRemoteServer, type_stat, type_metric, minutes);
