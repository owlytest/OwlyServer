...
logger.info("parameters received : nameserver="+nameRemServer+" and ipserver="+ipRemServer +" and type_stat="+type_stat+" and minutes_to_check="+minutes);
...
Set<String> typeMetric = remoteBasicStatMongoDAO.getTypeMetricFromStat(shortRemoteServer, type_stat,minutes)	;	
